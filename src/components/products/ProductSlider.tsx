...
infinite: true,
speed: 800,
slidesToShow: 4, // Pantalla grande
slidesToScroll: 1,
arrows: true,
autoplay: true,
autoplaySpeed: 2500,
...
return ( <div className="my-16 px-4 sm:px-6 lg:px-12"> <h2 className="text-3xl font-bold text-center mb-8 md:text-4xl lg:text-5xl">
{title} </h2>
  ...
  >
    {products.slice(0, 12).map((product, index) => (
      <div
        ...
        onMouseEnter={() => handleHover(index)} // hover en desktop
        onClick={() => sliderRef.current?.slickGoTo(index)} // click/tap en móviles
      >
        <CardProduct
          name={product.name}
          price={product.price}
